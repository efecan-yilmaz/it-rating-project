...
#         new_entries['voe'] = generate_random_scores(len(new_entries))
...
#     merged['voe'] = generate_random_scores(len(merged))
...
#         "voe": st.column_config.NumberColumn(label="VoE", format="%.1f", min_value=1.0, max_value=5.0),
#     }
