...
st.write("We’re glad you’re here! This website is the interactive demonstrator of a recommendation system developed as part of the <b>METIS Research Project founded by BMBF Germany.</b>", unsafe_allow_html=True)
